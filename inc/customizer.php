...
function gridsby_theme_customizer( $wp_customize ) {
  ...
  //Kristin Site Description Color
  $wp_customize->add_setting(
		'kristin_site_description_color',
		array(
				'default'     => '#404040',
        'sanitize_callback' => 'sanitize_hex_color',
		)
    ...
    new WP_Customize_Color_Control(
        ...
        array(
            'label'      => __( 'Site Description Color', 'kristin' ),
            'section'    => 'colors',
            'settings'   => 'kristin_site_description_color',
            'priority'   => 50
        )
    )
	);
  ...
  //Kristin Hover Color
  $wp_customize->add_setting( 'kristin_hover_color', array(
        'default'     => '#C2185B',
        'sanitize_callback' => 'sanitize_hex_color',
    ));
    ...
    new WP_Customize_Color_Control(
      ...
      'kristin_hover_color',
      array(
        'label'	   => __( 'Hover Color', 'kristin' ),
        'section'  => 'colors',
        'settings' => 'kristin_hover_color',
		    'priority' => 30
    )));

    //Kristin Hover Block Text Color
    $wp_customize->add_setting( 'kristin_hover_block_text_color', array(
          'default'     => '#FFF',
          'sanitize_callback' => 'sanitize_hex_color',
      ));
      ...
      new WP_Customize_Color_Control(
        $wp_customize,
        'kristin_hover_block_text_color',
        array(
          'label'	   => __( 'Hover Block Text Color', 'kristin' ),
          'section'  => 'colors',
          'settings' => 'kristin_hover_block_text_color',
  		    'priority' => 40
      )));
...
function gridsby_add_customizer_css() {
	...
	<style>
		...
		.site-title, .site-title a { color: <?php echo esc_attr( get_theme_mod( 'gridsby_site_title_color', '#FF0066' )) ?>; }
		<?php endif; ?>
    ...
    <?php if ( get_theme_mod( 'kristin_site_description_color' ) ) : ?>
		.site-description { color: <?php echo esc_attr( get_theme_mod( 'kristin_site_description_color', '#404040' )) ?>; }
		<?php endif; ?>
    ...
    <?php if ( get_theme_mod( 'kristin_hover_block_text_color' ) ) : ?>
    .menu > ul > li > a:hover { color: <?php echo esc_attr( get_theme_mod( 'kristin_hover_block_text_color', '#FFF' )) ?>; }
